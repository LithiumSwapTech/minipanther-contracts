...
contract sMP is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked MiniPanther", "sMP", 9) ERC20Permit() {
    ...
    /**
        @notice increases sMP supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sMP
